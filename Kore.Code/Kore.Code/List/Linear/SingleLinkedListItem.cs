...
namespace Kore.Code.List.Linear
{
    public class SingleLinkedListItem<T> : ListItem<T>
    {
        ...
        {
            get { throw new NotSupportedException("Prev is not supported by SingleLinkedListItem"); }
            set { throw new NotSupportedException("Prev is not supported by SingleLinkedListItem"); }
        }
    }
}